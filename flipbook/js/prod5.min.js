...
turnMethods = {
  ...
  _eventStart: function(e, opts, corner) {
    ...
    if (data.display=='single' && corner) {
      ...
      /*charAt(1) for sheet (tl, bl, tr, br). charAt(0) for hard (l, r)*/
      if (((corner.charAt(1)=='l' || corner.charAt(0)=='l') && data.direction=='ltr') ||
        ((corner.charAt(1)=='r' || corner.charAt(0)=='r') && data.direction=='rtl'))
      {
  ...
  _eventReleased: function(e, point) {
    ...
    if (turnData.display=='single') {
      outArea = (point.corner=='br' || point.corner=='tr' || point.corner == 'r') ?
 ...
 //
  _touchStart: function(e) {
    ...
    if (e != null && e.target != null && 
        ($(e.target).attr('data-disable-events') == 'true' || $(e.target).attr('data-disable-events') == 'start' || 
         $(e.target).closest('.layer-action-render').attr('data-disable-events') == 'true' || $(e.target).closest('.layer-action-render').attr('data-disable-events') == 'start')) {
        return;
    }
    
    if (window.disableTurnEvents != null && window.disableTurnEvents == true) {
        window.disableFirstMove = true;
        return;
    }
  ...
  _touchMove: function(e) {
    ...
    if (e != null && e.target != null && ($(e.target).attr('data-disable-events') == 'true' || $(e.target).closest('.layer-action-render').attr('data-disable-events') == 'true')) {
        return;
    }
    
    if (e != null && e.target != null &&
        ($(e.target).attr('data-disable-events') == 'start' || $(e.target).closest('.layer-action-render').attr('data-disable-events') == 'start') &&
        e.originalEvent != null && e.originalEvent.buttons != null && e.originalEvent.buttons == 0) {
        return;
    }    
  ...
  _updateShadow: function() {
    ...
    data.shadow.removeClass('shadow-half-left');
    data.shadow.removeClass('shadow-half-right');
...
flipMethods = {
  ...
  _cAllowed: function() {
    ...
    if (data.effect=='hard') {
      if (turnData.display=='single' && page != 1 && page != turnData.totalPages) {
          return ['r', 'l'];
      } else {
    ...
    switch (data.effect) {
      case 'hard':
        ...
        data.fpage = $('<div/>', divAtt(0, 0, 1)).
          css(cssProperties).
          appendTo(parent).addClass('fold-page');
      ...
      case 'sheet':
        ...
        data.fwrapper = $('<div/>', divAtt(parent.offset().top, parent.offset().left)).
          hide().
          appendTo(data.fparent).addClass('fold-wrapper');

        data.fpage = $('<div/>', divAtt(0, 0, 0, 'visible')).
          css({cursor: 'default'}).
          appendTo(data.fwrapper).addClass('fold-page');
    ...
    function EffectCards(_ref) {
      ...
      const setTranslate = () => {
        ...
        for (let i = 0; i < slides.length; i += 1) {
          ...
          /*heyzine: links not clickable on firefox only. The front slide z is smaller than the container z*/
          if (tZ == 0) {
              tZ = 1;
          }
          /*end heyzine*/
